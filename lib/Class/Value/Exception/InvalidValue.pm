...
Class::Value::Exception::InvalidValue - the Value Object design pattern

=head1 SYNOPSIS

    Class::Value::Exception::InvalidValue->new;
...
Class::Value::Exception::InvalidValue inherits from
L<Class::Value::Exception>.

The superclass L<Class::Value::Exception> defines these methods and
functions:

    PROPERTIES(), clear_ref(), clear_value(), ref(), ref_clear(), value(),
    value_clear()
...
The superclass L<Error> defines these methods and functions:
    ...
    flush(), import(), object(), prior(), record(), text(), throw(), with()
...
This document describes version 0.04 of L<Class::Value::Exception::InvalidValue>.

...
Class::Value::Notify - the Value Object design pattern

=head1 SYNOPSIS

    Class::Value::Notify->new;
...
Class::Value::Notify inherits from L<Class::Accessor::Complex>.
...
This document describes version 0.04 of L<Class::Value::Notify>.

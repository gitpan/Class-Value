...
Class::Value::Exception - the Value Object design pattern

=head1 SYNOPSIS

    Class::Value::Exception->new;
...
Class::Value::Exception inherits from L<Class::Value::Exception::Base>.
...
This document describes version 0.04 of L<Class::Value::Exception>.
